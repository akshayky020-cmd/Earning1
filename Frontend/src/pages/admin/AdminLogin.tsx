  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#121212] py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-[#1e1e1e] p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-white/5 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-red-500/10 rounded-full blur-2xl translate-y-1/2 -translate-x-1/2"></div>

        <div className="relative z-10">
          <div className="w-16 h-16 bg-red-50 dark:bg-red-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 transform -rotate-6 shadow-sm border border-red-100 dark:border-red-500/20">
        ...
        <form className="mt-8 space-y-6 relative z-10" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  {...register('identifier')}
                  className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 dark:bg-black/50 border border-gray-200 dark:border-white/10 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-gray-900 dark:text-white sm:text-sm transition-all"
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full flex justify-center items-center py-3.5 px-4 rounded-xl shadow-lg shadow-red-500/30 text-sm font-bold text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all active:scale-95 disabled:opacity-70 disabled:scale-100 group"
            >
